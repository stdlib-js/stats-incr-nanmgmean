...
> Compute a moving [geometric mean][geometric-mean] incrementally, ignoring `NaN` values.
...
```javascript
incrnanmgmean = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmgmean@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmgmean = require( 'path/to/vendor/umd/stats-incr-nanmgmean/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmgmean@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nanmgmean.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nanmgmean

[test-image]: https://github.com/stdlib-js/stats-incr-nanmgmean/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nanmgmean/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nanmgmean/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nanmgmean?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nanmgmean.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nanmgmean/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nanmgmean/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nanmgmean/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nanmgmean/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nanmgmean/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nanmgmean/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nanmgmean/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nanmgmean/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nanmgmean/main/LICENSE
